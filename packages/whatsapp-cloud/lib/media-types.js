 ...
 *    The human-readable description of this media type
 * @property {string} suffix
 *    The associated file suffix for this media type
 * @property {number} maxSize
 *    The maximum size for this media type on the Meta server
 */
 ...
 * @returns {string} The associated file suffix for this media type
 */
 ...
 * @returns {number} The size limit for the specified media type in bytes
 */
 ...
 * @returns {MediaType}
 *    The media type (MIME type) associated with the file's suffix
 */
