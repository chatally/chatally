...
For our funding through the [Prototype Fund](https://prototypefund.de), we had to propose some milestones, which you can find below. We will break down these work packages in our [backlog](/blog/backlog) and also continuously report our [sprint progress](/blog/progress).
