...
Here you will find all information about our development sprints in chronologically reverse order, i.e. newest first. If you want to find out whats coming next, check out our [backlog](./backlog).
...
- Publish WhatsApp connector
  ...
  - [ ] Clean-up code
  - [ ] Create Github workflow and publish NPM package as `@chatally/whatsapp-connector`
  - [ ] Provide docker setup (Github workflow?)
